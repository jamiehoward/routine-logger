          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" v-if="routineName" v-on:click="addRoutine()">
                    Add Routine
                </button>
                <button type="submit" class="btn btn-primary" v-if="!routineName" disabled>Add Routine</button>
              </div>
            </div>
          </div>
        </div>
